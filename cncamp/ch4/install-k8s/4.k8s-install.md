...
cn-master1   Ready      control-plane,master   14h   v1.24.4
cn-node1     NotReady   <none>                 32s   v1.24.4
```
...
NAME         STATUS   ROLES                  AGE     VERSION
cn-master1   Ready    control-plane,master   15h     v1.24.4
cn-node1     Ready    <none>                 8m45s   v1.24.4
```
cn-node1 is Ready
...
NAME         STATUS   ROLES                  AGE   VERSION
cn-master1   Ready    control-plane,master   15h   v1.24.4
cn-node1     Ready    worker                 13m   v1.24.4
```
